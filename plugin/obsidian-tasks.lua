...
vim.api.nvim_create_user_command(
  "ObsidianTasks",
  function() require("obsidian-tasks").open() end,
  { desc = "Open Obsidian tasks" }
)

vim.api.nvim_create_user_command(
  "ObsidianTasksCreate",
  function() require("obsidian-tasks").create() end,
  { desc = "Create an Obsidian task" }
)

vim.api.nvim_create_user_command(
  "ObsidianTasksRefresh",
  function() require("obsidian-tasks").refresh() end,
  { desc = "Refresh open Obsidian task views" }
)

vim.api.nvim_create_user_command(
  "ObsidianTasksSort",
  function(options) require("obsidian-tasks").sort(options.args ~= "" and options.args or nil) end,
  {
...
vim.api.nvim_create_user_command(
  "ObsidianTasksFilter",
  function(options) require("obsidian-tasks").filter(options.args ~= "" and options.args or nil) end,
  {
